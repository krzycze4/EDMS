...
class TestCaseContactCreateView(TestCase):
    @classmethod
...
class TestCaseContactCreateViewUserNotAuthenticated(TestCaseContactCreateView):
...
class TestCaseCompanyCreateViewUserGroupAccountants(TestCaseContactCreateView):
    def setUp(self) -> None:
        super().setUp()
...
class TestCaseCompanyCreateViewUserGroupCeos(TestCaseContactCreateView):
    def setUp(self) -> None:
        super().setUp()
...
class TestCaseCompanyCreateViewUserGroupHrs(TestCaseContactCreateView):
    def setUp(self) -> None:
        super().setUp()
...
class TestCaseCompanyCreateViewUserGroupManagers(TestCaseContactCreateView):
    def setUp(self) -> None:
        super().setUp()
