...
class AddendumFactory(DjangoModelFactory):
    ...
    create_date = factory.LazyAttribute(lambda obj: obj.agreement.end_date - timezone.timedelta(days=1))
    end_date = factory.LazyAttribute(lambda obj: obj.agreement.end_date + timezone.timedelta(days=365))
