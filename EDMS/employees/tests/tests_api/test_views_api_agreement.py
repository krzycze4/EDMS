...
class AgreementApiTestCase(EDMSTestCase):
    ...
    def test_accountant_can_update_addendum(self):
        login = self.client.login(email=self.accountant.email, password=self.password)
        self.assertTrue(login)
        count_addendum_before_response = Addendum.objects.count()
        response = self.client.put(
    ...
    def test_accountant_can_delete_addendum(self):
        login = self.client.login(email=self.accountant.email, password=self.password)
        self.assertTrue(login)
    ...
    def test_manager_can_create_addendum(self):
        login = self.client.login(email=self.manager.email, password=self.password)
        self.assertTrue(login)
        count_addendum_before_response = Addendum.objects.count()
        response = self.client.post(reverse_lazy("addendum-list"), self.addendum_data)
    ...
    def test_manager_can_update_addendum(self):
        login = self.client.login(email=self.manager.email, password=self.password)
        self.assertTrue(login)
        count_addendum_before_response = Addendum.objects.count()
        response = self.client.put(
    ...
    def test_manager_can_delete_addendum(self):
        login = self.client.login(email=self.manager.email, password=self.password)
        self.assertTrue(login)
        count_address_before_response = Addendum.objects.count()
        response = self.client.delete(
